...
//print_r($arr);
 ...
 $query=mysqli_query($con,"select food.foodname,food.mess_id,food.cost,food.image,cart.cart_id,cart.product_id,cart.customer_id from food inner  join cart on food.food_id=cart.product_id where cart.customer_id='$cust_id'");  $re=mysqli_num_rows($query);
?>
<html>
  <head>
      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item">
          ...
          <?php
			...
			{
			?>
			<a href="index.php?msg=you must be login first"><span style="color:red; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:red;" id="cart"  class="badge badge-light">0</span></i></span></a>
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="img/7.avif" alt="First slide">
    
	</div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/8.jfif" alt="Second slide">
