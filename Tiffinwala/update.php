   ...
   if(!empty($_SESSION['id']))	
   {
    ...
    if(!empty($chk)) 
	{
		if(empty($img_name))
	       ...
	       {
		          $paymentmode=implode(",",$chk);
	              if(mysqli_query($con,"update  food  set foodname='$food_name',cost='$cost',paymentmode='$paymentmode' where food_id='$food_id'"))
	     ...
	     else
		 {
			     ...
			     echo $paymentmode."<br>";
			     echo $img_name."<br>";
	             if(mysqli_query($con,"update  food  set foodname='$food_name',cost='$cost',paymentmode='$paymentmode', image='$img_name' where food_id='$food_id'"))
	
	                {
		             echo "update with new pic";
		             move_uploaded_file($_FILES['food_pic']['tmp_name'],"./img/Mess/$em/foodimages/".$_FILES['food_pic']['name']);
	                 unlink("./img/Mess/$em/foodimages/$rfldimageold");
					 header("location:update_food.php?food_id=$food_id");
					}
				 else
				 {
                  ...
                  <!--add Product-->
                        <form action="" method="post" enctype="multipart/form-data">
	                                ...
	                                <div class="form-group">
                                         ...
                                         <input type="file" accept="img/*" name="food_pic"/>Food Snaps 
                                    </div>
