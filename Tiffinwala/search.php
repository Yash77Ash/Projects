...
if(isset($_SESSION['cust_id']))
{
	 ...
	 $qq=mysqli_query($con,"select * from customer where email='$cust_id'");
...
$query=mysqli_query($con,"select * from mess where mess_id='$vid'");
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
		  ...
		  <?php
			...
			?>
			<li class="nav-item">
			  <a href="index.php?msg=you must be login first" class="nav-link"><span style="color:red;  font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:red;" id="cart"  class="badge badge-light">0</span></i></span></a>
		    </li>
