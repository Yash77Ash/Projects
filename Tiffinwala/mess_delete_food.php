...
{
$q=mysqli_query($con,"select mess.mess_name,food.image, mess.mess_id, mess.mess_email from mess inner join food on mess.mess_id=food.mess_id where food.food_id='$idd'");
$res=mysqli_fetch_assoc($q);
$e=$res['mess_email'];
$img=$res['image'];

unlink("img/Mess/$e/foodimages/$img");
