...
{
	header("location:deleteMess.php?Vendorid=$deleteVendor");
}
$admin_info=mysqli_query($con,"select * from admin where username='$admin_username'");
...
if(isset($update))
{
if(mysqli_query($con,"update admin set password='$password'"))
{
	 ...
	 <script>
			function delRecord(id)
			{
				...
				if(x== true)
				{
				  ...
				  window.location.href='deleteMess.php?Vendorid=' +id;		
				}
				else
				{
...
<div class="container">
	   ...
	   <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ED2553;border-radius:10px 10px 10px 10px;" role="tablist">
		  ...
		  <li class="nav-item">
              <a class="nav-link" style="color:#BDDEFD;"  id="ManageVendors-tab" data-toggle="tab" href="#ManageVendors" role="tab" aria-controls="ManageVendors" aria-selected="false">Manage Mess</a>
          </li>
		  <li class="nav-item">
                 ...
                 <thead>
                    <tr>
                        <th scope="col">Mess Id</th>
                            ...
                            <th scope="col">Remove Mess</th>
                     </tr>
                 </thead>
				 <tbody>
                 <?php
$query = mysqli_query($con, "SELECT mess.mess_id, mess.mess_name, mess.mess_email, food.food_id, food.foodname, food.image FROM mess RIGHT JOIN food ON mess.mess_id = food.mess_id");
...
?>
                    ...
                    <tr>
                        <th scope="row"><?php echo $row['mess_id'];?></th>
                        <td>
    <img src="img/Mess/<?php echo $row['mess_email'] ?>/foodimages/<?php echo $row['image'];?>" height="50px" width="100px">
...
<!--tab 1 ends-->	   
	...
	?>			 
                    ...
                    <td><img src="img/mess/<?php echo $row['mess_email'] . "/" . $row['mess_logo']; ?>" height="50px" width="100px"></td>

                        <th scope="row"><?php echo $row['mess_id'];?></th>
						<td><?php echo $row['mess_name'];?></td>
						<td><?php echo $row['mess_address'];?></td>
						...
						<form method="post">
                        <td><a href="#"  style="text-decoration:none; color:white;" onclick="delRecord(<?php echo $row['mess_id']; ?>)"><button type="button" class="btn btn-danger">Remove Mess</a></a></td>
                        </form>
                   </tr>
		<?php
		}
		?>		   
			 ...
			 <div class="tab-pane fade" id="orderstatus" role="tabpanel" aria-labelledby="orderstatus-tab">
			   ...
			   {
			   ?>
			   <td><i style="color:orange;" class="fas fa-exclamation-triangle"></i>&nbsp;<span style="color:red;"><?php echo $rrr['status']; ?></span></td>
			   <?php
			   }
			   else
			   ...
			   {
			   ?>
			   <td><span style="color:green;"><?php echo $rrr['status']; ?></span></td>
			   <?php
			   }
			   ?>
