...
if(isset($login))
{
	$query=mysqli_query($con,"select * from customer where cust_email='$email' && cust_password='$password'");
...
if(isset($register))
{
	...
	{
		if(mysqli_query($con,"insert into customer (cust_name,cust_email,cust_password,cust_mobile) values('$name',
...
<div class="middle" style=" margin:0px auto;width:500px;">
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ED2553;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" style="color:black;" id="login-tab" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="true">Log In</a>
          </li>
          <li class="nav-item">
